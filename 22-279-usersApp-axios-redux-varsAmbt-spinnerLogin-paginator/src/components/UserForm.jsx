...
export const UserForm = ({ userSelected, handlerCloseForm }) => {
    ...
    const onCheckboxChange = () => {
        setChecked(!checked);
          //se esparsen los datos del userForm y se agrega el valor del admin.
        setUserForm({
            ...userForm,
            admin : checked,
        });
    ...
    return (
        <form onSubmit={ onSubmit }>
            ...
            <p className="text-danger">{errors?.username}</p>                   {/* se le pone el """ ? """  pq puede q no venga el error en el username*/}
